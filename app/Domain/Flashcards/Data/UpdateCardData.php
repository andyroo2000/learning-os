...
final readonly class UpdateCardData
{
    private function __construct(
        ...
        public bool $hasAnswerAudioSource,
        public ?string $answerAudioSource,
    ...
    public static function fromInput(
        ...
        bool $hasAnswerAudioSource = false,
        ?string $answerAudioSource = null,
        ...
        return new self(
            ...
            hasAnswerAudioSource: $hasAnswerAudioSource,
            answerAudioSource: $hasAnswerAudioSource ? $answerAudioSource : null,
