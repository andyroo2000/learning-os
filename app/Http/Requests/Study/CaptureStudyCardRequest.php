...
class CaptureStudyCardRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'audio' => ['required', 'file', 'mimetypes:audio/wav,audio/x-wav,audio/vnd.wave', 'max:10240'],
            'image' => ['sometimes', 'file', 'image', 'mimetypes:image/jpeg,image/png,image/webp', 'max:10240'],
        ];
    }
