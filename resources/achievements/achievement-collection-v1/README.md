...
- `design.displaySize` fixes the visible client slot at 128 × 128. The standard 256-pixel asset is intentionally downsampled 2:1; high-density displays use the 512-pixel asset at the same visual size (4:1 source pixels).
