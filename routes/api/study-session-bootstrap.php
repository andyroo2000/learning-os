...
use App\Http\Controllers\Api\Study\StartLessonFollowupCohortController;
...
use App\Http\Controllers\Api\Study\StoreLessonFollowupCohortController;
...
return static function (): void {
    ...
    Route::post('/study/lessons/start', StartStudyLessonController::class)
        ->middleware('throttle:'.StudySessionStartRateLimiter::NAME);
    Route::post('/study/introduction-cohorts/lesson-followup', StoreLessonFollowupCohortController::class)
        ->middleware('throttle:'.StudySessionStartRateLimiter::NAME);
    Route::post('/study/introduction-cohorts/{cohortId}/lessons/start', StartLessonFollowupCohortController::class)
        ->whereUlid('cohortId')
        ->middleware('throttle:'.StudySessionStartRateLimiter::NAME);
