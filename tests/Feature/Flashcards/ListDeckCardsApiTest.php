...
class ListDeckCardsApiTest extends TestCase
{
    ...
    public function test_it_rejects_a_blank_deck_card_card_type_filter_without_global_trim_middleware(): void
    {
        ...
        $response = $this
            ->withoutMiddleware(TrimStrings::class)
            ->getJson("/api/decks/{$deck->id}/cards?card_type=%20%20%20");
    ...
    public function test_it_rejects_a_malformed_deck_card_card_type_filter(): void
    {
        ...
        $response = $this->getJson("/api/decks/{$deck->id}/cards?card_type=reverse");
    ...
    public function test_it_preserves_deck_card_card_type_filter_when_following_a_cursor(): void
    {
        ...
        $firstPage = $this->getJson("/api/decks/{$deck->id}/cards?card_type=production&per_page=1");
