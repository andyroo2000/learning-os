...
class ListDecksActionTest extends TestCase
{
    ...
    public function test_it_caps_the_page_size(): void
    {
        ...
        $decks = app(ListDecksAction::class)->handle($user->id, ListDecksAction::MAX_PAGE_SIZE + 1);

        $this->assertSame(ListDecksAction::MAX_PAGE_SIZE, $decks->perPage());
        $this->assertCount(ListDecksAction::MAX_PAGE_SIZE, $decks->items());
    }
