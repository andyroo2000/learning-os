    ...
    public function test_show_returns_overview_for_the_authenticated_user(): void
    {
        ...
        try {
            ...
            $this->getJson('/api/study/overview?time_zone=America/New_York')
                ...
                ->assertJsonPath('jlptMastery.N5.vocabulary.knownFromCards', 0)
                ->assertJsonPath('jlptMastery.N5.vocabulary.knownFromWaniKani', 0)
                ->assertJsonPath('jlptMastery.N5.vocabulary.knownFromBoth', 0)
                ...
                ->assertJsonPath('jlptMastery.N5.grammar.knownFromCards', 0)
                ->assertJsonPath('jlptMastery.N5.grammar.knownFromWaniKani', 0)
                ->assertJsonPath('jlptMastery.N5.grammar.knownFromBoth', 0)
    ...
    public function test_show_reports_ready_failed_cards_separately_from_due_cards(): void
    {
        ...
        try {
            ...
            $this->getJson('/api/study/overview')
                ...
                ->assertJsonPath('failedDueCount', 1)
                ->assertJsonPath('newCardsAvailableToday', 1)
                ->assertJsonStructure(['failedDueCount']);
        } finally {
            Carbon::setTestNow();
        }
    }
