...
class CardReviewEventCreateRateLimiterTest extends TestCase
{
    public function test_it_builds_stable_user_and_network_keys(): void
    {
        $limiter = new CardReviewEventCreateRateLimiter;

        $this->assertSame('card-review-event-create:user:42', $limiter->keyFor(42, '127.0.0.1'));
    ...
    {
        $limiter = new CardReviewEventCreateRateLimiter;
        $request = Request::create('/api/card-review-events', 'POST', [], [], [], ['REMOTE_ADDR' => '127.0.0.1']);
        ...
        $this->assertSame('card-review-event-create:user:42', $limit->key);
    }
}
