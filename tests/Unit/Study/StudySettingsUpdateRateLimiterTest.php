...
class StudySettingsUpdateRateLimiterTest extends TestCase
{
    public function test_it_builds_stable_user_and_network_keys(): void
    {
        ...
        $this->assertSame('study-settings-update:anon:127.0.0.1', $limiter->keyFor('', '127.0.0.1'));
        $this->assertSame('study-settings-update:anon:127.0.0.1', $limiter->keyFor(false, '127.0.0.1'));
        ...
        $this->assertSame('study-settings-update:user:0', $limiter->keyFor(0, '127.0.0.1'));
