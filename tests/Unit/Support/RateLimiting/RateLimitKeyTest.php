...
class RateLimitKeyTest extends TestCase
{
    public function test_it_builds_scoped_user_or_network_keys(): void
    {
        ...
        $this->assertSame('review-create:user:42', RateLimitKey::scopedUserOrNetwork('review-create', 42, null));
        ...
        $this->assertSame('review-create:anon:127.0.0.1', RateLimitKey::scopedUserOrNetwork('review-create', true, '127.0.0.1'));
        $this->assertSame('review-create:anon:127.0.0.1', RateLimitKey::scopedUserOrNetwork('review-create', 1.5, '127.0.0.1'));
    ...
    public function test_it_builds_unscoped_user_or_network_keys(): void
    {
        ...
        $this->assertSame('user:42', RateLimitKey::userOrNetwork(42, null));
        ...
        $this->assertSame('anon:127.0.0.1', RateLimitKey::userOrNetwork(true, '127.0.0.1'));
        $this->assertSame('anon:127.0.0.1', RateLimitKey::userOrNetwork(1.5, '127.0.0.1'));
